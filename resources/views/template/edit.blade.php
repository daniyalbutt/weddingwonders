...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">Edit Template - {{ $data->name }}</h6>
    <ul class="d-flex align-items-center gap-2">
        ...
        <li>-</li>
        <li class="fw-medium">Edit Template - {{ $data->name }}</li>
    </ul>
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Edit Template Form</h5>
            </div>
            <div class="card-body">
		        <form class="form" method="post" action="{{ route('templates.update', $data->id) }}">
		        	@csrf
					@method('PUT')
		            <div class="box-body">
						@if($errors->any())
		                ...
		                <div class="row gy-3">
							...
							@foreach($data->template_items as $key => $value)
							<div class="col-md-12">
								<div class="row mb-3">
									<div class="col-md-5">
										<div class="form-group">
							...
							<div class="col-12">
								<button type="submit" class="btn btn-primary-600 btn-sm">Update Template</button>
							</div>
		                </div>
		            </div>
		        </form>
...
<script>
	function deleteItem(a, id){
		...
		$.ajax({
			type:'POST',
			url:"{{ route('template-item.delete') }}",
			data:{id:id},
